...
class Icons {
    ...
    windSpeed      = '<svg viewBox="0 0 24 24"><path d="M4,10A1,1 0 0,1 3,9A1,1 0 0,1 4,8H12A2,2 0 0,0 14,6A2,2 0 0,0 12,4C11.45,4 10.95,4.22 10.59,4.59C10.2,5 9.56,5 9.17,4.59C8.78,4.2 8.78,3.56 9.17,3.17C9.9,2.45 10.9,2 12,2A4,4 0 0,1 16,6A4,4 0 0,1 12,10H4M19,12A1,1 0 0,0 20,11A1,1 0 0,0 19,10C18.72,10 18.47,10.11 18.29,10.29C17.9,10.68 17.27,10.68 16.88,10.29C16.5,9.9 16.5,9.27 16.88,8.88C17.42,8.34 18.17,8 19,8A3,3 0 0,1 22,11A3,3 0 0,1 19,14H5A1,1 0 0,1 4,13A1,1 0 0,1 5,12H19M18,18H4A1,1 0 0,1 3,17A1,1 0 0,1 4,16H18A3,3 0 0,1 21,19A3,3 0 0,1 18,22C17.17,22 16.42,21.66 15.88,21.12C15.5,20.73 15.5,20.1 15.88,19.71C16.27,19.32 16.9,19.32 17.29,19.71C17.47,19.89 17.72,20 18,20A1,1 0 0,0 19,19A1,1 0 0,0 18,18Z" /></svg>';
    cloudCover     = '<svg viewBox="0 0 24 24"><path d="M19.35,10.03C18.67,6.59 15.64,4 12,4C9.11,4 6.6,5.64 5.35,8.03C2.34,8.36 0,10.9 0,14A6,6 0 0,0 6,20H19A5,5 0 0,0 24,15C24,12.36 21.95,10.22 19.35,10.03Z" /></svg>';
    humidity       = '<svg viewBox="0 0 24 24"><path d="M12,3.25C12,3.25 6,10 6,14C6,17.32 8.69,20 12,20A6,6 0 0,0 18,14C18,10 12,3.25 12,3.25M14.47,9.97L15.53,11.03L9.53,17.03L8.47,15.97M9.75,10A1.25,1.25 0 0,1 11,11.25A1.25,1.25 0 0,1 9.75,12.5A1.25,1.25 0 0,1 8.5,11.25A1.25,1.25 0 0,1 9.75,10M14.25,14.5A1.25,1.25 0 0,1 15.5,15.75A1.25,1.25 0 0,1 14.25,17A1.25,1.25 0 0,1 13,15.75A1.25,1.25 0 0,1 14.25,14.5Z" /></svg>';
    pressure       = '<svg viewBox="0 0 24 24"><path d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,4A8,8 0 0,1 20,12C20,14.4 19,16.5 17.3,18C15.9,16.7 14,16 12,16C10,16 8.2,16.7 6.7,18C5,16.5 4,14.4 4,12A8,8 0 0,1 12,4M14,5.89C13.62,5.9 13.26,6.15 13.1,6.54L11.81,9.77L11.71,10C11,10.13 10.41,10.6 10.14,11.26C9.73,12.29 10.23,13.45 11.26,13.86C12.29,14.27 13.45,13.77 13.86,12.74C14.12,12.08 14,11.32 13.57,10.76L13.67,10.5L14.96,7.29L14.97,7.26C15.17,6.75 14.92,6.17 14.41,5.96C14.28,5.91 14.15,5.89 14,5.89M10,6A1,1 0 0,0 9,7A1,1 0 0,0 10,8A1,1 0 0,0 11,7A1,1 0 0,0 10,6M7,9A1,1 0 0,0 6,10A1,1 0 0,0 7,11A1,1 0 0,0 8,10A1,1 0 0,0 7,9M17,9A1,1 0 0,0 16,10A1,1 0 0,0 17,11A1,1 0 0,0 18,10A1,1 0 0,0 17,9Z" /></svg>';
    visibility     = '<svg viewBox="0 0 24 24"><path d="M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17M12,4.5C7,4.5 2.73,7.61 1,12C2.73,16.39 7,19.5 12,19.5C17,19.5 21.27,16.39 23,12C21.27,7.61 17,4.5 12,4.5Z" /></svg>';
    uvIndex        = '<svg viewBox="0 0 24 24"><path d="M11 1L13.39 4.42C12.65 4.15 11.84 4 11 4S9.35 4.15 8.61 4.42L11 1M2.34 6L6.5 5.65C5.9 6.16 5.36 6.78 4.94 7.5C4.5 8.24 4.25 9 4.11 9.79L2.34 6M2.36 16L4.12 12.23C4.26 13 4.53 13.78 4.95 14.5C5.37 15.24 5.91 15.86 6.5 16.37L2.36 16M19.65 6L17.88 9.79C17.74 9 17.47 8.23 17.05 7.5C16.63 6.78 16.1 6.15 15.5 5.64L19.65 6M23 13H21C21 15.05 20.22 17.1 18.66 18.66C17.09 20.23 15.05 21 13 21V23C15.56 23 18.12 22 20.07 20.07S23 15.56 23 13M19 13H17C17 14 16.61 15.05 15.83 15.83C15.05 16.61 14 17 13 17V19C14.54 19 16.08 18.41 17.25 17.24C18.41 16.08 19 14.54 19 13M11 8C12.65 8 14 9.35 14 11S12.65 14 11 14 8 12.65 8 11 9.35 8 11 8M11 6C8.24 6 6 8.24 6 11S8.24 16 11 16 16 13.76 16 11 13.76 6 11 6Z" /></svg>';
    dewPoint       = '<svg viewBox="0 0 24 24"><path d="M17 3H21V5H17V3M17 7H21V9H17V7M17 11H21V13H17.75L17 12.1V11M21 15V17H19C19 16.31 18.9 15.63 18.71 15H21M7 3V5H3V3H7M7 7V9H3V7H7M7 11V12.1L6.25 13H3V11H7M3 15H5.29C5.1 15.63 5 16.31 5 17H3V15M15 13V5C15 3.34 13.66 2 12 2S9 3.34 9 5V13C6.79 14.66 6.34 17.79 8 20S12.79 22.66 15 21 17.66 16.21 16 14C15.72 13.62 15.38 13.28 15 13M12 4C12.55 4 13 4.45 13 5V8H11V5C11 4.45 11.45 4 12 4Z" /></svg>';
    sunrise        = '<svg viewBox="0 0 24 24"><path d="M3,12H7A5,5 0 0,1 12,7A5,5 0 0,1 17,12H21A1,1 0 0,1 22,13A1,1 0 0,1 21,14H3A1,1 0 0,1 2,13A1,1 0 0,1 3,12M15,12A3,3 0 0,0 12,9A3,3 0 0,0 9,12H15M12,2L14.39,5.42C13.65,5.15 12.84,5 12,5C11.16,5 10.35,5.15 9.61,5.42L12,2M3.34,7L7.5,6.65C6.9,7.16 6.36,7.78 5.94,8.5C5.5,9.24 5.25,10 5.11,10.79L3.34,7M20.65,7L18.88,10.79C18.74,10 18.47,9.23 18.05,8.5C17.63,7.78 17.1,7.15 16.5,6.64L20.65,7M12.71,16.3L15.82,19.41C16.21,19.8 16.21,20.43 15.82,20.82C15.43,21.21 14.8,21.21 14.41,20.82L12,18.41L9.59,20.82C9.2,21.21 8.57,21.21 8.18,20.82C7.79,20.43 7.79,19.8 8.18,19.41L11.29,16.3C11.5,16.1 11.74,16 12,16C12.26,16 12.5,16.1 12.71,16.3Z" /></svg>';
    sunset         = '<svg viewBox="0 0 24 24"><path d="M3,12H7A5,5 0 0,1 12,7A5,5 0 0,1 17,12H21A1,1 0 0,1 22,13A1,1 0 0,1 21,14H3A1,1 0 0,1 2,13A1,1 0 0,1 3,12M15,12A3,3 0 0,0 12,9A3,3 0 0,0 9,12H15M12,2L14.39,5.42C13.65,5.15 12.84,5 12,5C11.16,5 10.35,5.15 9.61,5.42L12,2M3.34,7L7.5,6.65C6.9,7.16 6.36,7.78 5.94,8.5C5.5,9.24 5.25,10 5.11,10.79L3.34,7M20.65,7L18.88,10.79C18.74,10 18.47,9.23 18.05,8.5C17.63,7.78 17.1,7.15 16.5,6.64L20.65,7M12.71,20.71L15.82,17.6C16.21,17.21 16.21,16.57 15.82,16.18C15.43,15.79 14.8,15.79 14.41,16.18L12,18.59L9.59,16.18C9.2,15.79 8.57,15.79 8.18,16.18C7.79,16.57 7.79,17.21 8.18,17.6L11.29,20.71C11.5,20.9 11.74,21 12,21C12.26,21 12.5,20.9 12.71,20.71Z" /></svg>';
    moonrise       = '<svg viewBox="0 0 24 24"><path d="M3,12h4c0-2.8,2.2-5,5-5s5,2.2,5,5h4c0.6,0,1,0.4,1,1s-0.4,1-1,1H3c-0.6,0-1-0.4-1-1S2.4,12,3,12 M15,12c0-1.7-1.3-3-3-3 s-3,1.3-3,3H15 M12.7,16.3l3.1,3.1c0.4,0.4,0.4,1,0,1.4s-1,0.4-1.4,0L12,18.4l-2.4,2.4c-0.4,0.4-1,0.4-1.4,0c-0.4-0.4-0.4-1,0-1.4 l3.1-3.1c0.2-0.2,0.4-0.3,0.7-0.3S12.5,16.1,12.7,16.3z"/></svg>';
    moonset        = '<svg viewBox="0 0 24 24"><path d="M3,12h4c0-2.8,2.2-5,5-5s5,2.2,5,5h4c0.6,0,1,0.4,1,1s-0.4,1-1,1H3c-0.6,0-1-0.4-1-1S2.4,12,3,12 M15,12c0-1.7-1.3-3-3-3 s-3,1.3-3,3H15 M12.7,20.7l3.1-3.1c0.4-0.4,0.4-1,0-1.4c-0.4-0.4-1-0.4-1.4,0L12,18.6l-2.4-2.4c-0.4-0.4-1-0.4-1.4,0 c-0.4,0.4-0.4,1,0,1.4l3.1,3.1c0.2,0.2,0.4,0.3,0.7,0.3S12.5,20.9,12.7,20.7z"/></svg>';
    tempHigh       = '<svg viewBox="0 0 24 24"><path d="M19 11V8H17V11H14V13H17V16H19V13H22V11M11 13V5C11 3.34 9.66 2 8 2S5 3.34 5 5V13C2.79 14.66 2.34 17.79 4 20S8.79 22.66 11 21 13.66 16.21 12 14C11.72 13.62 11.38 13.28 11 13M8 4C8.55 4 9 4.45 9 5V8H7V5C7 4.45 7.45 4 8 4Z" /></svg>';
    tempLow        = '<svg viewBox="0 0 24 24"><path d="M22 11H14V13H22V11M11 13V5C11 3.34 9.66 2 8 2S5 3.34 5 5V13C2.79 14.66 2.34 17.79 4 20S8.79 22.66 11 21 13.66 16.21 12 14C11.72 13.62 11.38 13.28 11 13M8 4C8.55 4 9 4.45 9 5V8H7V5C7 4.45 7.45 4 8 4Z" /></svg>';
    ...
    weather(cond, tod) {
        ...
        switch (true) {
            ...
            // Clear
            case ((cond === 'clear sky') && (tod === 'day')):
                icon = this.clearDay;
                break;
            case ((cond === 'clear sky') && (tod === 'night')):
            ...
            // Drizzle
            case (cond === 'light intensity drizzle'):
                icon = this.rain;
                break;
            case (cond === 'drizzle'):
                icon = this.rain;
                break;
            case (cond === 'heavy intensity drizzle'):
                icon = this.rain;
                break;
            case (cond === 'light intensity drizzle rain'):
                icon = this.rain;
                break;
            case (cond === 'drizzle rain'):
                icon = this.rain;
                break;
            case (cond === 'heavy intensity drizzle rain'):
                icon = this.rain;
                break;
            case (cond === 'shower rain and drizzle'):
                icon = this.rain;
                break;
            case (cond === 'heavy shower rain and drizzle'):
                icon = this.rainHeavy;
                break;
            case (cond === 'shower drizzle'):
                icon = this.rain;
                break;

            // Rain
            case (cond === 'light rain'):
                icon = this.rain;
                break;
            case (cond === 'moderate rain'):
                icon = this.rain;
                break;
            case (cond === 'heavy intensity rain'):
                icon = this.rainHeavy;
                break;
            case (cond === 'very heavy rain'):
                icon = this.rainHeavy;
                break;
            case (cond === 'extreme rain'):
                icon = this.rainHeavy;
                break;
            case (cond === 'freezing rain'):
                icon = this.sleet;
                break;
            case (cond === 'light intensity shower rain'):
                icon = this.rain;
                break;
            case (cond === 'shower rain'):
                icon = this.rain;
                break;
            case (cond === 'heavy intensity shower rain'):
                icon = this.rainHeavy;
                break;
            case (cond === 'ragged shower rain'):
                icon = this.rainScattered;
                break;

            // Storm
            case (cond === 'thunderstorm with light rain'):
                icon = this.storm;
                break;
            case (cond === 'thunderstorm with rain'):
                icon = this.storm;
                break;
            case (cond === 'thunderstorm with heavy rain'):
                icon = this.stormSevere;
                break;
            case (cond === 'light thunderstorm'):
                icon = this.storm;
                break;
            case (cond === 'thunderstorm'):
                icon = this.storm;
                break;
            case (cond === 'heavy thunderstorm'):
                icon = this.stormSevere;
                break;
            case (cond === 'ragged thunderstorm'):
                icon = this.stormScattered;
                break;
            case (cond === 'thunderstorm with light drizzle'):
                icon = this.storm;
                break;
            case (cond === 'thunderstorm with drizzle'):
                icon = this.storm;
                break;
            case (cond === 'thunderstorm with heavy drizzle'):
                icon = this.stormSevere;
                break;

            // Snow
            case (cond === 'light snow'):
                icon = this.snow;
                break;
            case (cond === 'snow'):
                icon = this.snow;
                break;
            case (cond === 'heavy snow'):
                icon = this.snowHeavy;
                break;
            case (cond === 'sleet'):
                icon = this.sleet;
                break;
            case (cond === 'light shower sleet'):
                icon = this.sleet;
                break;
            case (cond === 'shower sleet'):
                icon = this.sleet;
                break;
            case (cond === 'light rain and snow'):
                icon = this.sleet;
                break;
            case (cond === 'rain and snow'):
                icon = this.sleet;
                break;
            case (cond === 'light shower snow'):
                icon = this.snow;
                break;
            case (cond === 'shower snow'):
                icon = this.snow;
                break;
            case (cond === 'heavy shower snow'):
                icon = this.snowHeavy;
                break;
    ...
    /**
     * Get Moon Phase
     * @param {string} moon - Moon Phase (0.0 - 1.0)
     * @returns {object} - Moon Phase Object
     */
    moon(moon) {
        const phase = parseFloat(moon)
        let svg;
        let txt;
        switch (true) {
